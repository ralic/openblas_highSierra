...
#  3.  Ensure that Release builds use Ofast instead of O3
#
#=============================================================================
# Author: Chuck Atkins
# Copyright 2011
...
elseif( CMAKE_Fortran_COMPILER_ID STREQUAL "HP" )
  ...
  set( CMAKE_Fortran_FLAGS_DEBUG "${CMAKE_Fortran_FLAGS_RELEASE} +Ofast"
       CACHE STRING "Flags used by the compiler during release builds" FORCE )
  set( CMAKE_Fortran_FLAGS_DEBUG "${CMAKE_Fortran_FLAGS_RELWITHDEBINFO} +Ofast -g"
...
if( "${CMAKE_Fortran_FLAGS_RELEASE}" MATCHES "O[3-9]" )
  message( STATUS "Reducing RELEASE optimization level to Ofast" )
  string( REGEX REPLACE "O[3-9]" "Ofast" CMAKE_Fortran_FLAGS_RELEASE
